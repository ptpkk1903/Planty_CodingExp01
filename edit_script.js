...
function send_event(form){
    ...
    form_data.append("cmm", "edit-event");
    form_data.append("objid", document.getElementById('id-objid').value);
...
function send_status(form){
  ...
  var form_data = new FormData();
  form_data.append("cmm", "edit-status");
  form_data.append("objid", document.getElementById('id-objid').value);
...
function send_topic(form){
  ...
  var form_data = new FormData();
  form_data.append("cmm", "edit-topic");
  form_data.append("objid", document.getElementById('id-objid').value);
...
function send_work(form){
  ...
  var form_data = new FormData();
  form_data.append("cmm", "edit-work");
  form_data.append("objid", document.getElementById('id-objid').value);
